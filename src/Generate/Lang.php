...
//        //TODO also with prefix
        ...
        $fileName = Str::kebab($this->moduleName);
        $path = base_path("Modules/{$this->moduleName}/Resources/lang/$locale/{$fileName}.php");
        $search = "// Do not delete me :) I'm used for auto-generation" . PHP_EOL;
        $replace = $this->buildClass() . PHP_EOL;
        $defaultContent = "<?php" . PHP_EOL . PHP_EOL . "return [" . PHP_EOL . "    // Do not delete me :) I'm used for auto-generation" . PHP_EOL . "];";

        if ($this->replaceIfNotPresent($path, $search, $replace, $defaultContent)) {
