...
class ViewFullForm extends ViewGenerator
{
    ...
    public function handle()
    {
        ...
        $viewPath = base_path("Modules/{$this->moduleName}/Resources/views/{$this->fileName}.blade.php");
        ...
        $formJsPath = base_path("Modules/{$this->moduleName}/Resources/js/$this->formJsRelativePath/Form.js");
        ...
        $indexJsPath = base_path("Modules/{$this->moduleName}/Resources/js/$this->formJsRelativePath/index.js");
    ...
    protected function buildForm()
    {
        return view('brackets/admin-generator::' . $this->view, [
            ...
            'columns' => $this->getVisibleColumns($this->tableName, $this->modelVariableName)->sortByDesc(function (
                $column
            ) {
