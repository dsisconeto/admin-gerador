...
abstract class ClassGenerator extends Command
{
    ...
    {
        return [
            ['module', InputArgument::REQUIRED, 'Name of the module'],
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($this instanceof Model) {
            $this->initCommonNames($this->argument('table_name'), $this->argument('class_name'), null,
                $this->option('model-with-full-namespace'));
        } else {
            $this->initCommonNames($this->argument('table_name'), $this->option('model-name'), null,
                $this->option('model-with-full-namespace'));
        }
