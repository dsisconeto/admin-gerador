...
class ViewIndex extends ViewGenerator
{
    ...
    public function handle()
    {
        ...
        $viewPath = base_path("Modules/{$this->moduleName}/Resources/views/{$this->modelViewsDirectory}/index.blade.php");
        $listingJsPath = base_path("Modules/{$this->moduleName}/Resources/js/{$this->modelJSName}/Listing.js");
