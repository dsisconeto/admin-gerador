...
class ViewForm extends ViewGenerator
{
    ...
    public function handle()
    {
        ...
        $viewPath = base_path("Modules/{$this->moduleName}/Resources/views/{$this->modelViewsDirectory}/components/form-elements.blade.php");
        ...
        if (in_array("published_at",
            array_column($this->getVisibleColumns($this->tableName, $this->modelVariableName)->toArray(), 'name'))) {
            $viewPath = resource_path("Modules/{$this->moduleName}/Resources/views/{$this->modelViewsDirectory}/components/form-elements-right.blade.php");
            if ($this->alreadyExists($viewPath) && !$force) {
                $this->error('File ' . $viewPath . ' already exists!');
            } else {
                if ($this->alreadyExists($viewPath) && $force) {
        ...
        $viewPath = base_path("Modules/{$this->moduleName}/Resources/views/$this->modelViewsDirectory/create.blade.php");
        if ($this->alreadyExists($viewPath) && !$force) {
            $this->error('File ' . $viewPath . ' already exists!');
        } else {
            if ($this->alreadyExists($viewPath) && $force) {
        ...
        $viewPath = base_path("Modules/{$this->moduleName}/Resources/views/{$this->modelViewsDirectory}/edit.blade.php");
        if ($this->alreadyExists($viewPath) && !$force) {
            $this->error('File ' . $viewPath . ' already exists!');
        } else {
            if ($this->alreadyExists($viewPath) && $force) {
        ...
        $formJsPath = base_path("Modules/{$this->moduleName}/Resources/js/$this->modelJSName/Form.js");
        ...
        $indexJsPath = base_path("Modules/{$this->moduleName}/Resources/js/$this->modelJSName/index.js");
        $bootstrapJsPath = base_path("Modules/{$this->moduleName}/Resources/js/index.js");
